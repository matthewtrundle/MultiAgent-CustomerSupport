...
const mockTickets = [
  {
    id: '1',
    title: 'Calendar sync broken with VRBO',
    customer: { name: 'Sarah Chen', email: 'sarah.chen@email.com' },
  ...
  {
    id: '2',
    title: 'Guest demanding refund after full stay',
  ...
  {
    id: '3',
    title: 'How to set up weekend pricing?',
...
const mockAgentActivity = [
  {
    ...
    currentTicket: { id: '4', title: 'New ticket: Payout not received for 3 bookings' },
    confidence: 0.85,
    lastActive: new Date(),
  },
  {
    agentType: 'TECHNICAL',
    status: 'processing' as const,
    currentTicket: { id: '1', title: 'Calendar sync broken with VRBO' },
    confidence: 0.72,
    lastActive: new Date(),
  },
  {
...
export default function DashboardPage() {
  ...
  return (
    <div className="p-6">
      <div className="mb-8">
        <h1 className="text-2xl font-semibold text-gray-900">Vacation Rental Support Dashboard</h1>
        <p className="mt-1 text-sm text-gray-600">
          Monitor host and guest support tickets across all categories
        </p>
      </div>
